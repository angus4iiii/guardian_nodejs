...
if (typeof fetch === 'undefined') {
  try {
    ...
    console.warn(
      'global.fetch is not available. For local debug runs please either run with Node >= 18 or install node-fetch@2:'
    )
...
module.exports = {
  exampleCrankMaps,
  performRun,
  runExampleTestByIndex,
  uploadRunForItem,
  testUploadExampleCrankMap,
}
